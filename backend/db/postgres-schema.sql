...
CREATE INDEX IF NOT EXISTS idx_ironing_sessions_status_started ON ironing_sessions(status, started_at DESC, id DESC);
CREATE INDEX IF NOT EXISTS idx_ironing_sessions_basket_status ON ironing_sessions(basket_id, status);
CREATE UNIQUE INDEX IF NOT EXISTS idx_ironing_sessions_active_basket ON ironing_sessions(basket_id) WHERE status = 'active';
...
CREATE INDEX IF NOT EXISTS idx_pickup_order_placements_active_location ON pickup_order_placements(location_qr_code) WHERE released_at IS NULL;
