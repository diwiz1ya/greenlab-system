...
- Rework list/context reads и QC basket lookup/error events уже вынесены в SQLite rework repository.
...
- rework list/context reads and QC basket lookup/error events
